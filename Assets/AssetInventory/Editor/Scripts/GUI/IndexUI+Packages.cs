...
namespace AssetInventory
{
    public partial class IndexUI
    {
        ...
        private void DrawPackagesTab()
        {
            ...
            AssetInventory.Config.onlyInProject = EditorGUILayout.ToggleLeft(UIStyles.Content(caption, "Show only packages that are used inside the current project. Will require a full project scan via the reporting tab, done automatically in the background."), AssetInventory.Config.onlyInProject);
            if (EditorGUI.EndChangeCheck())
            {
                CreateAssetTree();
                AssetInventory.SaveConfig();
